...
namespace PixivDownloader2
{
    public class PixivURLHelper
    {
        ...
        private static readonly string illustUrlFormat = "https://www.pixiv.net/member_illust.php?mode=medium&illust_id={0}";
        ...
        private static readonly string mangaPageUrlFormat = "https://www.pixiv.net/member_illust.php?mode=manga&illust_id={0}";
        private static readonly string mangaBigPageUrlFormat = "https://www.pixiv.net/member_illust.php?mode=manga_big&illust_id={0}&page={1}";
